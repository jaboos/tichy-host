...
export const cs = {
  ...
  // Jména brigády. Patří sem ze stejného důvodu jako názvy chodů: jsou to
  // viditelné řetězce, a když se vezmou z id až při vykreslení, přepnutí
  // jazyka uprostřed sezóny přejmenuje i kuchaře v rozehrané pozici.
  'cook.bartakova.first': 'Ilona',
  'cook.bartakova.last': 'Bartáková',
  'cook.ryba.first': 'Marek',
  'cook.ryba.last': 'Ryba',
  'cook.vanous.first': 'Petr',
  'cook.vanous.last': 'Vaňous',
  'cook.kesslerova.first': 'Dita',
  'cook.kesslerova.last': 'Kesslerová',
  'cook.hruba.first': 'Jana',
  'cook.hruba.last': 'Hrubá',
  'cook.brichtova.first': 'Ela',
  'cook.brichtova.last': 'Brichtová',
  'cook.dolezal.first': 'Vít',
  'cook.dolezal.last': 'Doležal',
  'cook.novakova.first': 'Radka',
  'cook.novakova.last': 'Nováková',
  'cook.simek.first': 'Ondřej',
  'cook.simek.last': 'Šimek',
  'cook.kolar.first': 'Tomáš',
  'cook.kolar.last': 'Kolář',
  'cook.sykorova.first': 'Věra',
  'cook.sykorova.last': 'Sýkorová',
  'cook.benes.first': 'Filip',
  'cook.benes.last': 'Beneš',
  'cook.malkova.first': 'Lucie',
  'cook.malkova.last': 'Málková',
  'cook.zeman.first': 'Karel',
  'cook.zeman.last': 'Zeman',
  'cook.rehorova.first': 'Alena',
  'cook.rehorova.last': 'Řehořová',
  'cook.prochazka.first': 'Jiří',
  'cook.prochazka.last': 'Procházka',
  'cook.vlckova.first': 'Simona',
  'cook.vlckova.last': 'Vlčková',
  'cook.sedlacek.first': 'Adam',
  'cook.sedlacek.last': 'Sedláček',
  'cook.jandova.first': 'Petra',
  'cook.jandova.last': 'Jandová',
  'cook.bilek.first': 'Roman',
  'cook.bilek.last': 'Bílek',
  'cook.krejci.first': 'Matěj',
  'cook.krejci.last': 'Krejčí',
  'cook.zelena.first': 'Nikola',
  'cook.zelena.last': 'Zelená',
  'cook.hruska.first': 'David',
  'cook.hruska.last': 'Hruška',
  'cook.peroutkova.first': 'Klára',
  'cook.peroutkova.last': 'Peroutková',
  ...
  'fb.prompt.no': 'Teď ne',
  'fb.title': 'Pět otázek',
  'fb.intro': 'Odpovědi mi řeknou, co doladit. Kteroukoli otázku můžeš přeskočit.',
  'fb.q1': 'Kde to skončilo?',
  'fb.q1.finished': 'Dohráno až do konce',
  'fb.q1.bored': 'Přestalo mě to bavit',
  'fb.q1.stuck': 'Nebylo jasné, co dál',
  'fb.q1.broken': 'Něco vypadalo rozbitě',
  'fb.q1.no_time': 'Došel mi čas, vrátím se',
  'fb.q2': 'Laťka — číslo, se kterým se poměřuje každý talíř.',
  'fb.q2.used': 'Řídím se jí při rozdělování',
  'fb.q2.saw': 'Byla vidět, ale nic podle ní neměním',
  'fb.q2.never': 'Nebylo jasné, k čemu je',
  'fb.q2.unseen': 'Ušla mi',
  'fb.q3': 'Když přišel verdikt sezóny, jak seděl?',
  'fb.q3.expected': 'Odpovídal průběhu sezóny',
  'fb.q3.better': 'Líp, než se dalo čekat',
  'fb.q3.worse': 'Hůř, než se dalo čekat',
  'fb.q3.coinflip': 'Přišlo mi to jako hod mincí',
  'fb.q3.not_far': 'Tak daleko to nedošlo',
  'fb.q4': 'Přitlačit — pět mosazných žetonů na sezónu.',
  'fb.q4.deliberate': 'Používám je cíleně na vybrané večery',
  'fb.q4.curious': 'Jeden na zkoušku, co to udělá',
  'fb.q4.saw': 'Zůstaly nepoužité',
  'fb.q4.unknown': 'Uniklo mi, že tam jsou',
  'fb.q5': 'Co je poslední věc, na kterou si vzpomeneš, než tě to přestalo bavit?',
  'fb.q5.placeholder': 'Klidně jednou větou.',
  'fb.submit': 'Odeslat',
  'fb.sending': 'Odesílá se…',
  'fb.thanks': 'Díky. Kód kuchyně jel s tím — tvoji sezónu si přehraju přesně.',
  'fb.failed': 'Odeslání se nepovedlo. Zkus to prosím ještě jednou.',
  'fb.close': 'Zavřít',
  'fb.privacy':
    'Ukládá se jen tohle, kód kuchyně a číslo večera. Žádné jméno, žádný e-mail, žádné cookies.',
  ...
  'monday.outlookAfter': 'zůstane {cash}',
  'monday.outlookRisk': 'Pod nulou přebírá podnik investor.',

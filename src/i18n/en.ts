...
export const en = {
  ...
  // The brigade's names, in the dictionary for the same reason the courses are:
  // they are visible strings, and resolving them from an id at render time is
  // what lets a mid-season language switch rename the cooks too.
  'cook.bartakova.first': 'Iris',
  'cook.bartakova.last': 'Barton',
  'cook.ryba.first': 'Marcus',
  'cook.ryba.last': 'Fisher',
  'cook.vanous.first': 'Peter',
  'cook.vanous.last': 'Vance',
  'cook.kesslerova.first': 'Dita',
  'cook.kesslerova.last': 'Kessler',
  'cook.hruba.first': 'Jane',
  'cook.hruba.last': 'Rudd',
  'cook.brichtova.first': 'Ella',
  'cook.brichtova.last': 'Bright',
  'cook.dolezal.first': 'Victor',
  'cook.dolezal.last': 'Doyle',
  'cook.novakova.first': 'Rachel',
  'cook.novakova.last': 'Newman',
  'cook.simek.first': 'Andrew',
  'cook.simek.last': 'Simms',
  'cook.kolar.first': 'Thomas',
  'cook.kolar.last': 'Wheeler',
  'cook.sykorova.first': 'Vera',
  'cook.sykorova.last': 'Finch',
  'cook.benes.first': 'Philip',
  'cook.benes.last': 'Bennett',
  'cook.malkova.first': 'Lucy',
  'cook.malkova.last': 'Small',
  'cook.zeman.first': 'Charles',
  'cook.zeman.last': 'Yeoman',
  'cook.rehorova.first': 'Elena',
  'cook.rehorova.last': 'Gregory',
  'cook.prochazka.first': 'George',
  'cook.prochazka.last': 'Walker',
  'cook.vlckova.first': 'Simone',
  'cook.vlckova.last': 'Wolfe',
  'cook.sedlacek.first': 'Adam',
  'cook.sedlacek.last': 'Farmer',
  'cook.jandova.first': 'Petra',
  'cook.jandova.last': 'Jansen',
  'cook.bilek.first': 'Roman',
  'cook.bilek.last': 'White',
  'cook.krejci.first': 'Matthew',
  'cook.krejci.last': 'Taylor',
  'cook.zelena.first': 'Nicola',
  'cook.zelena.last': 'Green',
  'cook.hruska.first': 'David',
  'cook.hruska.last': 'Pearson',
  'cook.peroutkova.first': 'Clara',
  'cook.peroutkova.last': 'Featherstone',
  ...
  'fb.prompt.yes': "I'll answer",
  'fb.prompt.no': 'Not now',
  'fb.title': 'Five questions',
  'fb.intro': 'The answers tell me what to fix. Skip any of them.',
  'fb.q1': 'Where did you stop?',
  'fb.q1.finished': 'Played the season through',
  'fb.q1.bored': 'Got bored',
  'fb.q1.stuck': "Wasn't sure what to do next",
  'fb.q1.broken': 'Something looked broken',
  'fb.q1.no_time': "Ran out of time, I'd come back",
  'fb.q2': 'The bar — the number every plate is scored against.',
  'fb.q2.used': 'I used it when assigning cooks',
  'fb.q2.saw': 'I saw it, but it changed nothing',
  'fb.q2.never': 'Never worked out what it was for',
  'fb.q2.unseen': 'Missed it entirely',
  'fb.q3': "When the season's verdict came, how did it land?",
  'fb.q3.expected': 'About what the season deserved',
  'fb.q3.better': 'Better than expected',
  'fb.q3.worse': 'Worse than expected',
  'fb.q3.coinflip': 'Felt like a coin flip',
  'fb.q3.not_far': "Didn't get that far",
  'fb.q4': 'Push — five brass tokens a season.',
  'fb.q4.deliberate': 'Spent them on chosen evenings',
  'fb.q4.curious': 'Tried one to see what it did',
  'fb.q4.saw': 'Saw them, never used them',
  'fb.q4.unknown': "Didn't know they were there",
  'fb.q5': 'What is the last thing you remember thinking before you stopped?',
  'fb.q5.placeholder': 'One sentence is plenty.',
  'fb.submit': 'Send',
  'fb.sending': 'Sending…',
  'fb.thanks': 'Thank you. The kitchen code went with it, so I can replay your exact season.',
  'fb.failed': "That didn't send. Please try once more.",
  'fb.close': 'Close',
  'fb.privacy':
    'Stored: these answers, the kitchen code and the evening number. No name, no email, no cookies.',
  ...
  'monday.outlookAfter': '{cash} left',
  'monday.outlookRisk': 'Below zero an investor takes the place over.',
  ...
  'verdict.nextSeason': 'Next season',
  'verdict.again': 'New career',
  'verdict.careerStep': 'Season {n} of {total}',
